 ...
 *
 */
public class SAXExternalViewerBuilder implements ContentHandler {
    private ArrayList viewers;
    private ExternalViewer viewer;
     ...
     *
     */
    public SAXExternalViewerBuilder() {
        super();
    ...
    public void endElement(
        ...
        if (localName.equals("handle")) {
            viewer.addHandle(buf.toString());
        } else if (localName.equals("viewer")) {
            viewers.add(viewer);
        } else if (localName.equals("name")) {
            viewer.setName(buf.toString());
        } else if (localName.equals("command")) {
            viewer.setCommand(buf.toString());
        } else if (localName.equals("platform")) {
            viewer.setPlatform(buf.toString());
        } else if (localName.equals("icon")) {
            viewer.setIcon(buf.toString());
        }
    }
    ...
    public void startElement(
        ...
        if (localName.equals("viewer")) {
            viewer = new ExternalViewer();
        } else {
