...
public class TaskDialogImpl implements TaskDialog, ProjectConfigListener {
     ...
     * (non-Javadoc)
     *
     * @see de.miethxml.gui.project.TaskSettings#init()
     *
     */
    public void initialize() {
        ...
        builder.add(new LocaleSeparator(
                "view.task.settings.separator.description"), cc.xywh(2, 8, 5, 1));
        description = new JTextArea(5, 20);

        JScrollPane sp = new JScrollPane(description);
        builder.add(sp, cc.xy(4, 10));

        //TODO change to a Locale
        tp.addTab("Main", builder.getPanel());

        //the process settings
        layout = new FormLayout("3dlu,right:pref,2dlu,pref,2dlu,fill:pref:grow,2dlu,pref,3dlu",
                "3dlu,p,3dlu,p,2dlu,p,2dlu,p,2dlu,p,9dlu,p,3dlu,p,2dlu,p,fill:3dlu:grow,9dlu,p,3dlu,p,2dlu,p,fill:3dlu:grow,2dlu,p,2dlu,p,2dlu,p,3dlu");
        builder = new PanelBuilder(layout);
        cc = new CellConstraints();
        builder.add(new LocaleSeparator("view.task.settings.separator.general"),
            cc.xywh(2, 2, 7, 1));
        followLinks = new JCheckBox();
        builder.add(followLinks,
            cc.xy(4, 4, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        builder.add(new LocaleLabel("view.task.settings.label.followlinks"),
            cc.xy(6, 4));
        confirmExtension = new JCheckBox();
        builder.add(confirmExtension,
            cc.xy(4, 6, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        builder.add(new LocaleLabel("view.task.settings.label.confirmextension"),
            cc.xy(6, 6));
        partial = new JCheckBox();
        builder.add(partial,
            cc.xy(4, 8, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        builder.add(new LocaleLabel("view.task.settings.label.partial"),
            cc.xy(6, 8));
        clean = new JCheckBox();
        builder.add(clean,
            cc.xy(4, 10, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        builder.add(new LocaleLabel("view.task.settings.label.clean"),
            cc.xy(6, 10));
        builder.add(new LocaleSeparator("view.task.settings.separator.uris"),
            cc.xywh(2, 12, 7, 1));
        uris = new JList();
        ...
        builder.add(new LocaleSeparator(
                "view.task.settings.separator.urisettings"),
            cc.xywh(2, 19, 7, 1));
        builder.add(new LocaleLabel("view.task.settings.label.sitemapuris"),
            cc.xy(2, 21));
        sitemap = new JList();
        ...
        changeURIButton = new LocaleButton(
                "view.task.settings.button.changeuri");
        ...
        builder.add(new LocaleLabel("view.task.settings.label.uri"),
            cc.xy(2, 26));
        uriEdit = new JTextField(20);

        //uriEdit.setActionCommand(ACTION_URI_ADD);
        //uriEdit.addActionListener(controller);
        builder.add(uriEdit, cc.xywh(4, 26, 3, 1));
        builder.add(new LocaleLabel("view.task.settings.label.srcprefix"),
            cc.xy(2, 28, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        srcPrefix = new JTextField(20);
        builder.add(srcPrefix, cc.xywh(4, 28, 3, 1));
        builder.add(new LocaleLabel("view.task.settings.label.type"),
            cc.xy(2, 30, CellConstraints.RIGHT, CellConstraints.DEFAULT));
        ...
        //publishing
        layout = new FormLayout("3dlu,right:pref,2dlu,pref,2dlu,fill:pref:grow,2dlu,pref,3dlu",
                "3dlu,p,3dlu,p,2dlu,p,fill:3dlu:grow,9dlu,p,3dlu,p,2dlu,p,2dlu,p,2dlu,p,3dlu");
        builder = new PanelBuilder(layout);
        cc = new CellConstraints();
        builder.add(new LocaleSeparator(
                "view.task.settings.separator.publishingdestinations"),
            cc.xywh(2, 2, 7, 1));
        publish = new JList();
        ...
        builder.add(new LocaleSeparator(
                "view.task.settings.separator.publishingoptions"),
            cc.xywh(2, 9, 7, 1));
        builder.add(new LocaleLabel("view.task.settings.label.publishname"),
            cc.xy(2, 11));
        ...
        builder.add(new LocaleLabel("view.task.settings.label.publishsource"),
            cc.xy(2, 13));
        ...
        changePublishButton = new LocaleButton(
                "view.task.settings.button.changepublish");
        ...
        builder.add(new LocaleLabel(
                "view.task.settings.label.publishdestination"), cc.xy(2, 15));
        publishDestination = new JTextField(20);
        builder.add(publishDestination, cc.xy(4, 15));
        builder.add(new LocaleLabel("view.task.settings.label.publishtarget"),
            cc.xy(2, 17));
     ...
     * (non-Javadoc)
     *
     * @see de.miethxml.gui.project.TaskSettings#setTask(de.miethxml.project.Task)
     *
     */
     ...
     * (non-Javadoc)
     *
     * @see de.miethxml.gui.project.TaskSettings#setVisible(boolean)
     *
     */
    public void setVisible(boolean state) {
        if (state) {
            ...
            if (project.getPublishTargetCount() > 0) {
                ...
                //no PublishRoot -> so we can not edit something
                //on the publishPanel
     ...
     * (non-Javadoc)
     *
     * @see de.miethxml.gui.project.TaskDialog#newTask()
     *
     */
    public void newTask() {
        controller.newTask();
     ...
     * (non-Javadoc)
     *
     * @see de.miethxml.gui.project.TaskDialog#setProject(de.miethxml.project.Project)
     *
     */
    ...
    private ListModel createSitemapList() {
        ...
        SitemapWrapper sitemapmodel = sax.parseURI(project.getCocoonBeanConfiguration()
                                                          .getContextDir()
    ...
    private class Controller implements ActionListener, ListSelectionListener {
            ...
            if (cmd.equals(ACTION_CANCEL)) {
                ...
                if (validateMsg.size() > 0) {
                    ...
                    int option = JOptionPane.showConfirmDialog(dialog, list,
                            LocaleImpl.getInstance().getString("view.task.validate.message"),
                ...
                int option = fc.showDialog(null,
                        LocaleImpl.getInstance().getString("view.task.settings.dialog.destination"));
                ...
                //we remove from list and set the edit fields
                ...
                if (publishTarget.getSelectedIndex() > -1) {
                    ...
                    PublishTarget pt = (PublishTarget) publishTarget
                        .getSelectedItem();
                    ...
                    JOptionPane.showMessageDialog(dialog,
                        LocaleImpl.getInstance().getString("view.task.validate.no_publishroot_selected"),
                ...
                int option = fc.showDialog(null,
                        LocaleImpl.getInstance().getString("view.task.settings.dialog.publish"));
                ...
                if (index >= 0) {
                    PublishDestination pd = (PublishDestination) task.getPublishDestinations()
                                                                     .get(index);
        ...
        private void updateTask() {
            ...
            //set the destination to all URI's
            while (i.hasNext()) {
        ...
        public void setTask(Task task) {
            //work first with the clone
            //changes will not set if some
            //hit "cancel" after complex changes
            newTask = false;
