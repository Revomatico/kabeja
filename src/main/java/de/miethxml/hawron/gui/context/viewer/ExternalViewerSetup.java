 ...
 *
 */
public class ExternalViewerSetup extends AbstractServiceable
    implements Initializable, GuiConfigurable, ActionListener {
    ...
    private JPanel createSetupPanel() {
        FormLayout panellayout = new FormLayout("3dlu,pref,3dlu,pref:grow,3dlu,pref,3dlu,pref:grow,3dlu",
                "3dlu,p,3dlu,p,2dlu,p,2dlu,p,3dlu:grow,9dlu,p,3dlu,p,2dlu,p,2dlu,p,2dlu,p,2dlu,p,20dlu:grow,3dlu");
