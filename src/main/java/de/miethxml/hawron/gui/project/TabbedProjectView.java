 ...
 *
 */
public class TabbedProjectView implements Cacheable, ActionListener,
     ...
     *
     */
    public TabbedProjectView() {
    }

    public TabbedProjectView(Project project) {
    }
    ...
    public void initialize() {
        ...
        parent = new JPanel();
        parent.setLayout(dockletContainer);
        ...
        tp.addChangeListener(new ChangeListener() {
                public void stateChanged(ChangeEvent e) {
                    ...
                    dockletContainer.show(parent, "" + (index + 1));
