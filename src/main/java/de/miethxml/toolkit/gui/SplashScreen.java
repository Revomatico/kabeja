...
public class SplashScreen extends Window implements Runnable {
    public final static int VMARGIN = 40;
    public final static int HMARGIN = 10;
    ...
    public void setMaximum(int max) {
        ...
        //the empty progressbar
        for (int i = 0; i < process; i++) {
            g.drawRect(5 + (i * (elementLength + space)), height + 10,
    ...
    private void paintNextProgress(
        int next,
        String msg) {
        Graphics2D g2 = (Graphics2D) buffer.getGraphics();
        ...
        //fill last step
        g2.setColor(pcolor);
        g2.fillRect(5 + (next * (elementLength + space)) + 1, height + 11,
            elementLength - 1, elementHeight - 1);
    ...
    private void paintNextSubStep(int current) {
        ...
        if (hasSubStebs) {
            ...
            //we start not at 3 o'clock position
